...
describe("BinaryTree", () => {
  describe("constructor", () => {
    ...
    test("Should add non-node parameter as a root node element", () => {
      ...
      expect(JSON.stringify(binaryTree.rootNode())).toEqual(
        JSON.stringify(new Node(5))
      );
    });
  ...
  describe("add", () => {
    ...
    test("Should add second element as the leftChild of the root", () => {
      ...
      expect(JSON.stringify(binaryTree.rootNode().leftChild)).toEqual(
        JSON.stringify(expectedNode)
      );
    });
    ...
    test("Should add a third element as the rightChild of the root", () => {
      ...
      expect(JSON.stringify(binaryTree.rootNode().rightChild)).toEqual(
        JSON.stringify(expectedNode)
      );
    });
    ...
    test("Should add a fourth element as the leftChild of the leftChild of the root", () => {
      ...
      expect(JSON.stringify(binaryTree.rootNode().leftChild.leftChild)).toEqual(
        JSON.stringify(expectedNode)
      );
    });
    ...
    test("Should add a fifth element as the rightChild of the leftChild of the root", () => {
      ...
      expect(
        JSON.stringify(binaryTree.rootNode().leftChild.rightChild)
      ).toEqual(JSON.stringify(expectedNode));
    });

    test("Should add a sixth element as the leftChild for the rightChild of the root", () => {
      const valueToTest = 5;
      const expectedNode = new Node(valueToTest);
      ...
      expect(
        JSON.stringify(binaryTree.rootNode().rightChild.leftChild)
      ).toEqual(JSON.stringify(expectedNode));
    });
  });
});
